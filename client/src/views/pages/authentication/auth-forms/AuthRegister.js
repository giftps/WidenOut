            ...
            >
                {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                    <form noValidate onSubmit={handleSubmit} {...others}>
                        ...
                        <FormControl
                            fullWidth
                            error={Boolean(touched.cf_password && errors.cf_password)}
                            sx={{ ...theme.typography.customInput }}
                        >
                            ...
                            <OutlinedInput
                                ...
                                inputProps={{}}
                            />
                            {touched.cf_password && errors.cf_password && (
                                <FormHelperText error id="standard-weight-helper-text-cf_password-register">
                                    {errors.cf_password}
                                </FormHelperText>
                            )}
                        </FormControl>
                        ...
                        <FormControl fullWidth error={Boolean(touched.gender && errors.gender)} sx={{ ...theme.typography.customInput }}>
                            {/* <InputLabel htmlFor="demo-row-radio-buttons-group-label">Gender</InputLabel> */}
                            <RadioGroup
                                onBlur={handleBlur}
                                onChange={handleChange}
                                row
