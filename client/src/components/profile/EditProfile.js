...
const EditProfile = ({ setOnEdit }) => {
    ...
    return (
        <div className="edit_profile">
            <button type="button" className="btn btn-danger btn_close" onClick={() => setOnEdit(false)}>
                Close
            </button>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form_group">
                    ...
                    <input type="text" className="form-control" id="mobile" name="mobile" value={mobile} onChange={handleInput} />
                </div>
                ...
                <div className="input-group-prepend px-0 mb-4">
                    <select className="custom-select text-capitalize" name="gender" id="gender" onChange={handleInput} value={gender}>
