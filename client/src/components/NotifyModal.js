...
const NotifyModal = () => {
    ...
    return (
        ...
        >
            ...
            <hr className="mt-1" />
            {notify.data.length === 0 && <span className="text-muted w-100 text-center">No Notifications</span>}
                ...
                {notify.data.map((msg, index) => (
                    <div className="px-2 mb-3" key={index}>
                        ...
                        >
                            ...
                            <div style={{ width: '30px' }}>{msg.image && <Avatar src={msg.image} size="medium-avatar" />}</div>
                        </Link>
            ...
            <hr className="my-1" />
            <div className="text-end my-auto me-2 color-c1" style={{ cursor: 'pointer' }} onClick={handleDeleteAll}>
                Mark All As Read
            </div>
        </div>
    );
