            ...
            <div className="main__container">
                ...
                <div className="main__cards">
                    <div className="card_admin">
                        <i className="fa fa-users fa-2x text-lightblue" aria-hidden="true" />
                    ...
                    <div className="card_admin">
                        ...
                        <div className="card_inner_admin">
                            ...
                            <span className="font-bold text-title">{admin.total_comments}</span>
                        </div>
                    </div>

                    <div className="card_admin">
                        <i className="fa fa-camera fa-2x text-yellow" aria-hidden="true" />
                        <div className="card_inner_admin">
                    ...
                    <div className="card_admin">
                        <i className="fa fa-check-circle fa-2x  text-green" aria-hidden="true" />
                        <div className="card_inner_admin">
                            <p className="text-primary-p">Total Active Users</p>
                            <span className="font-bold text-title">{admin.total_active_users}</span>
                        </div>
                    </div>
                </div>
