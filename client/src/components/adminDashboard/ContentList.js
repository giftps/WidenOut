                ...
                content.map((post) => (
                    <div className="admin_content_display">
                        ...
                        <div className="d-flex">
                            ...
                            <span className="spam_time text-muted">~{moment(post.createdAt).fromNow()}</span>
                        </div>
                        <div className="ms-auto d-flex flex-column " style={{ cursor: 'pointer' }} onClick={() => handleDeletePost(post)}>
