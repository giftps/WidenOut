...
const Menu = () => {
    const navLinks = [
        ...
        { label: 'Message', icon: 'email', path: '/message' },
            ...
            <ul className="navbar-nav flex-row mb-2 mb-lg-0">
                ...
                <li className="nav-item dropdown" style={{ opacity: '1' }}>
                    ...
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li>
                            <Link style={{ color: 'white' }} className="dropdown-item" to={`/profile/${auth.user._id}`}>
                                Profile
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link style={{ color: 'white' }} className="dropdown-item" to="/" onClick={() => dispatch(logout())}>
                                Logout
                            </Link>
                        </li>
                    </ul>
