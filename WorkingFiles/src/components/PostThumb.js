...
const PostThumb = ({ posts, result }) => {
    ...
    const imageShow = (src) => <img src={src} alt={src} style={{ filter: theme ? 'invert(1)' : 'invert(0)' }} />;

    const videoShow = (src) => <video controls src={src} alt={src} style={{ filter: theme ? 'invert(1)' : 'invert(0)' }} />;
    return (
